...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=10", "Noto Color Emoji:pixelsize=10:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY,	XK_o,		spawn,		SHCMD("lfopen") },
	...
	{ MODKEY, XK_b,				spawn,		SHCMD("dmbluetooth") },
